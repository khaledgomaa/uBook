...
function createCategDiv(i, objectKeys, checkFirstcreation) {
    ...
    if (checkFirstcreation) {
        ...
        document.getElementById("categories").insertBefore(catBooksdiv, document.getElementById(nextNode));
    }
    ...
    leftimg.addEventListener("click", (function (catBooksdivID, i) {
            return function() { return clickLeft(catBooksdivID, i); };
    })(catBooksdivID, i));

    if (checkFirstcreation) { leftimg.style.visibility = "hidden"; }
    ...
    var rightimgdiv = document.createElement("div");
          ...
          document
            .getElementById(rightDid).append(rightimg);
...
function createBooksDiv(i, j, objectKeys, categData) {
    ...
    bkimg.addEventListener( "click", (function (bookid) {
            return function () { return cookie.setCookie("selectedBook", bookid); };
    })(bookid));
    ...
    priceLabel.innerHTML ="$" + booksJsObj[Object.keys(booksJsObj)[i]][j]["price"];
