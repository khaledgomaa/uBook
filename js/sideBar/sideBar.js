...
function createDiv(i,categTitle){
    $("#sideCategDiv").append(
        ...
        "<a href='selectedCateg.html'><input type='button' class='categbtn' id='"+(i+1)+"' value='"+categTitle+"'></a>"+
        "</div>"
    );
...
function createSlider(){
    ...
    $("#slider-range").append("<input type='range' min='"+min +"' max='"+max+"' value='"+max+"' class='slider' id='myRange'><br/><a href='booksByPrice.html'><input type='button' value='Find books in range' id='rangebtn' class='categbtn'></a>");
