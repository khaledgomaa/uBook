...
document.getElementsByClassName("displayEvent1")[0].classList.add("detailsActive");


var collectionInfoHeader = document.getElementsByClassName("events-schedule")[0].children;
var collectionDisplayInfo = document.getElementsByClassName("eventsDetails")[0].children;
