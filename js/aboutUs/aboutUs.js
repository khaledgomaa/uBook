...
document.getElementsByClassName("displayourTeam")[0].classList.add("displayactive");

var collectionInfoHeader = document.getElementsByClassName("aboutUsInfo")[0].children;
var collectionDisplayInfo = document.getElementsByClassName("displayAboutUsInfo")[0].children;
